...
class BirtDomBuilderTest {
    ...
    void shouldInitializeRootNode() throws Exception {
        ...
        assertThat(rootElement.getAttribute("xmlns")).isEqualTo("http://www.eclipse.org/birt/2005/design");
    ...
    void shouldAppendElement() throws Exception {
        ...
        Node paramNode = (Node) xpath.evaluate("/report/parameters", builder.getDocument(), XPathConstants.NODE);
    ...
    void shouldBuildDynamicDataSource() throws Exception {
        ...
        Node dataSourceNode = (Node) xpath.evaluate("/report/data-sources/oda-data-source", doc, XPathConstants.NODE);
        ...
        assertThat(xpath.evaluate("/report/data-sources/oda-data-source/property[@name='odaDriverClass']/text()", doc))
                .isEqualTo(testDriver);
        assertThat(xpath.evaluate("/report/data-sources/oda-data-source/property[@name='odaURL']/text()", doc))
                .isEqualTo(testUrl);
        assertThat(xpath.evaluate("/report/data-sources/oda-data-source/property[@name='odaUser']/text()", doc))
                .isEqualTo(testUser);
        assertThat(xpath.evaluate(
                        "/report/data-sources/oda-data-source/encrypted-property[@name='odaPassword']/text()", doc))
                .isEqualTo(testPass);
    }
}
