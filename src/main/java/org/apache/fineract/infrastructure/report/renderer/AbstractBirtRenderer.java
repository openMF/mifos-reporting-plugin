...
public abstract class AbstractBirtRenderer implements BirtRenderer {
    ...
    @Override
    public Response render(IReportEngine reportEngine, String documentPath, String reportName) throws Exception {
    ...
    protected abstract IRenderOption createRenderOption(OutputStream output, String reportName) throws Exception;
